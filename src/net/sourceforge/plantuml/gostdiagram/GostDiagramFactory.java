...
public class GostDiagramFactory extends PSystemCommandFactory {

	public GostDiagramFactory() {
		super(DiagramType.GOST);
	}
	...
	@Override
	public GostDiagram createEmptyDiagram(UmlSource source, Map<String, String> skinParam) {
		return new GostDiagram(source, skinParam);
	}
